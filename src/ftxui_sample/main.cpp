...
// configuration step. It creates a namespace called `cppTemplate`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cppTemplate::cmake::project_name, cppTemplate::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cppTemplate::cmake::project_version);
      return EXIT_SUCCESS;
    }
